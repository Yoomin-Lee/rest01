...
## 7. 학원강사 포트폴리오로 방향 전환 (2026년 8월 13일)

**배경**
- 기존 "History Researcher & Junior Web Developer" 웹개발 지향 포트폴리오를 학원강사 구직용으로 전환
- 폼(레이아웃·섹션 구성)과 개인정보는 유지하되, 콘텐츠 전반을 지도 과목 중심으로 재구성

**Hero 섹션**
- 태그라인: "History Researcher & Junior Web Developer" → "초·중등 역사·사회 전문 강사"
- 지도 과목 배지 신규 추가: 초등 국어 / 초·중등 역사 / 초·중등 사회 (`.hero-subjects`, `.subject-badge`)
- 순차 등장 애니메이션 시퀀스에 배지 요소 포함

**소개 섹션**
- 사료 분석 능력을 학생 눈높이 수업(스토리텔링·타임라인 시각화)으로 연결하는 강사 관점 서술로 재작성

**지도 역량 섹션 (구 "기술 스택")**
- 좌측 컬럼: Web Development(HTML/CSS/JS/Git) → 지도 가능 과목(초등 국어 · 초등 사회 · 중등 역사 · 중등 사회)
- 우측 컬럼(Research & Analysis)은 기존 유지
- 섹션 타이틀 "기술 스택" → "지도 역량", 내비게이션 라벨 "기술" → "역량"

**SEO / 메타태그**
- `og:title`, `og:description`, `twitter:title/description`을 학원강사 소개 문구로 갱신
- `<title>` "이유민 — Portfolio" → "이유민 — 학원강사 포트폴리오"

**프로필 사진 교체**
- 업로드된 증명사진(`20260323_이유민_3.jpg`)을 `images/profile.jpg`로 정리
- 기존 `images/profile.png` 삭제, `index.html`의 히어로 이미지 참조 경로 갱신
...
| `d730887` | 학원강사 포트폴리오로 방향 전환 (초중등 역사/사회, 초등 국어) |
| `84354c7` | 원격 업로드 사진 병합 (Merge) |
| `476623f` | 증명사진으로 프로필 이미지 교체 |
